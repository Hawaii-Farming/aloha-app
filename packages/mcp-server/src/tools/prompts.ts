...
**Aloha Standards Review Criteria:**
...
- Use of @aloha/ui components and established patterns
...
4. **Best Practices:** Relevant patterns from the Aloha codebase
5. **Security Review:** Any security concerns or improvements`,
    ...
    },
    {
      ...
      description:
        'Design Row Level Security policies for Aloha multi-tenant architecture',
      category: 'database',
      arguments: [
        {
          name: 'table_name',
...
- Use of existing Aloha functions: has_role_on_account, has_permission
...
- Leverage roles and role_permissions for granular access`,
      examples: [
        ...
        'Set up RLS for user-specific records',
      ],
    },
  ];
