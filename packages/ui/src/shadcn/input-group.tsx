  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Focus state — hairline ring + border color shift (no thick halo).
        'has-[[data-slot=input-group-control]:focus-visible]:border-ring has-[[data-slot=input-group-control]:focus-visible]:ring-ring/35 has-[[data-slot=input-group-control]:focus-visible]:ring-1',
