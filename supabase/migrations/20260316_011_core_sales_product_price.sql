...
COMMENT ON COLUMN sales_product_price.product_id IS 'Product this price applies to';
COMMENT ON COLUMN sales_product_price.fob_id IS 'FOB delivery point this price applies to';
COMMENT ON COLUMN sales_product_price.cust_id IS 'Specific customer for customer-level pricing; NULL for group or default pricing';
COMMENT ON COLUMN sales_product_price.cust_group_id IS 'Customer group for group-level pricing; NULL for customer-specific or default pricing';
