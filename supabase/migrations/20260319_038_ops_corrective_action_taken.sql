...
COMMENT ON COLUMN ops_corrective_action_taken.fsafe_emp_result_id IS 'Null if triggered by a checklist response; FK added via ALTER TABLE in fsafe_emp_result migration';
