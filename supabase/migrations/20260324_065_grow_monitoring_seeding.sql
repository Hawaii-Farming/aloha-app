CREATE TABLE IF NOT EXISTS grow_monitoring_seeding (
    ...
    CONSTRAINT uq_grow_monitoring_seeding UNIQUE (ops_task_tracker_id, grow_seeding_id)
);
...
CREATE INDEX idx_grow_monitoring_seeding_seeding ON grow_monitoring_seeding (grow_seeding_id);
