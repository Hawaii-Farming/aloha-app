...
CREATE INDEX idx_hr_work_authorization_active ON hr_work_authorization (org_id, is_active);
...
COMMENT ON COLUMN hr_work_authorization.is_active IS 'Soft delete flag; false hides the type from active use';
