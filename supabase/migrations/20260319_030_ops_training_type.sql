...
CREATE INDEX idx_ops_training_type_active ON ops_training_type (org_id, is_active);
...
COMMENT ON COLUMN ops_training_type.is_active IS 'Soft delete flag; false hides the type from active use';
