CREATE TABLE IF NOT EXISTS grow_spraying_input (
    ...
    grow_input_compliance_id    UUID REFERENCES grow_input_compliance(id),
...
COMMENT ON COLUMN grow_spraying_input.grow_input_compliance_id IS 'Active compliance record for this product; used to derive PHI/REI safety intervals';
