...
CREATE INDEX idx_hr_department_active ON hr_department (org_id, is_active);
...
COMMENT ON COLUMN hr_department.is_active IS 'Soft delete flag; false hides the department from active use';
