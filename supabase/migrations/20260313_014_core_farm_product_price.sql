...
CREATE TABLE IF NOT EXISTS farm_product_price (
    ...
    fob_id            UUID NOT NULL REFERENCES freight_on_board(id),
...
-- Index for price lookups by product and FOB
CREATE INDEX idx_farm_product_price_lookup ON farm_product_price (product_id, fob_id, effective_from);
