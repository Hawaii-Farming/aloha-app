...
values (
       ...
       (
           'member',
           'invites.manage');-- Consumer Dev Tables: Minimal stand-ins for local development
--
-- In production, the consumer project (e.g. aloha-app) provides these tables.
-- Here we create minimal versions so the view contracts in 18-view-contracts.sql
...
-- ============================================================
-- Phase 3: Navigation & Access Control tables
-- ============================================================
