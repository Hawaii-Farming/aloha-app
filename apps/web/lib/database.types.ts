    ...
    Tables: {
        ...
        Relationships: [
          {
            ...
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "app_org_context"
          ...
          },
          {
            ...
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "app_user_orgs"
            referencedColumns: ["org_id"]
          },
          {
            foreignKeyName: "fsafe_lab_org_id_fkey"
      ...
      hr_module_access: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "app_nav_modules"
      ...
      invnt_po_received: {
        Row: {
          ...
          delivery_truck_clean: boolean | null
          farm_id: string | null
          id: string
          invnt_lot_id: string | null
          invnt_po_id: string
      ...
      pack_shelf_life: {
        Row: {
          ...
          farm_id: string | null
          id: string
          invnt_item_id_pack: string | null
          is_deleted: boolean
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "pack_shelf_life_invnt_item_id_pack_fkey"
            columns: ["invnt_item_id_pack"]
            isOneToOne: false
            referencedRelation: "invnt_item"
            referencedColumns: ["id"]
          },
      ...
      sales_po: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sales_po_farm_id_fkey"
            columns: ["farm_id"]
            isOneToOne: false
            referencedRelation: "org_farm"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "sales_po_uploaded_by_fkey"
            columns: ["uploaded_by"]
            isOneToOne: false
            referencedRelation: "app_org_context"
            referencedColumns: ["employee_id"]
      ...
      sales_product: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sales_product_invnt_item_id_pack_fkey"
            columns: ["invnt_item_id_pack"]
            isOneToOne: false
            referencedRelation: "invnt_item"
            referencedColumns: ["id"]
