...
| `grow_input_compliance` | Chemical label registry — provides PHI/REI for safety interval calculation |
...
1. For each `grow_spraying_input` row, look up the linked `grow_input_compliance` record
