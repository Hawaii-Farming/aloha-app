...
| grow_cycle_pattern_id | TEXT | FK → grow_cycle_pattern(id), nullable | |
| grow_trial_type_id | TEXT | FK → grow_trial_type(id), nullable | |
| grow_seed_mix_id | TEXT | FK → grow_seed_mix(id), nullable | |
...
| seeding_uom | TEXT | NOT NULL, FK → sys_uom(code) | |
...
| estimated_harvest_date | DATE | NOT NULL | Auto-calculated: seeding_date plus grow_cycle_pattern duration |
...
| grow_pest_id | TEXT | FK → grow_pest(id), nullable | |
| grow_disease_id | TEXT | FK → grow_disease(id), nullable | |
| severity_level | TEXT | NOT NULL, CHECK | low, moderate, high, severe |
| disease_infection_stage | TEXT | nullable, CHECK | early, mid, late, advanced |
| notes | TEXT | nullable | |
...
| burn_uom | TEXT | NOT NULL, FK → sys_uom(code) | |
...
| response_type | TEXT | NOT NULL, default 'numeric', CHECK | numeric, boolean, text |
| point_type | TEXT | NOT NULL, default 'direct', CHECK | direct, calculated |
| formula | TEXT | nullable | |
| input_point_ids | JSONB | nullable | |
