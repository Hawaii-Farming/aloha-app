...
`invnt_usage` and `invnt_sales_product_item` are designed but deferred from the MVP. See [Future Improvements](20260319_07_future.md) for table definitions and planned features.
