...
`invnt_usage` and `invnt_sales_product_item` are designed but deferred from the MVP. See [Future Improvements](20260326_11_future.md) for table definitions and planned features.
