...
| name                     | TEXT         | NOT NULL                              | |
| qb_account            | TEXT         | nullable                              | Identifier used to link this item to the accounting system |
...
| invnt_category_id    | TEXT         | NOT NULL, FK → invnt_category(id)     | |
| invnt_item_id        | TEXT         | FK → invnt_item(id), nullable         | |
| item_name            | TEXT         | NOT NULL                              | |
| burn_uom             | TEXT         | NOT NULL, FK → sys_uom(code)         | |
| order_uom            | TEXT         | NOT NULL, FK → sys_uom(code)         | |
...
| received_uom         | TEXT         | NOT NULL, FK → sys_uom(code)         | |
