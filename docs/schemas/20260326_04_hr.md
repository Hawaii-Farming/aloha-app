...
| team_lead_id             | TEXT         | FK → hr_employee(id), nullable           | |
| compensation_manager_id  | TEXT         | FK → hr_employee(id), nullable           | |
...
| overtime_threshold       | NUMERIC      | nullable                                 | |
