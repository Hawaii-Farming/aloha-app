...
| formula | TEXT | nullable | Expression for calculated points (e.g. (drain_ml / drip_ml) * 100); null for direct |
...
| value | NUMERIC | nullable | For direct points entered manually, for calculated points computed from formula |
