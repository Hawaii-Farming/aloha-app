...
erDiagram
    ...
    grow_seed_batch ||--o{ grow_harvest : harvests
    org_site ||--o{ grow_harvest : located
    grow_grade ||--o{ grow_harvest : grades
    ops_task_tracker ||--o{ grow_harvest : tracks
    grow_harvest ||--o{ grow_harvest_weight : weighs
    grow_harvest_container ||--o{ grow_harvest_weight : uses
    org_farm ||--o{ grow_pest : tracks
    org_farm ||--o{ grow_disease : tracks
    ops_task_tracker ||--o{ grow_scout_seeding : covers
    grow_seed_batch ||--o{ grow_scout_seeding : inspected
    ...
    ops_task_tracker ||--o{ grow_spray_seeding : covers
    grow_seed_batch ||--o{ grow_spray_seeding : treated
    ...
    grow_seed_batch ||--o{ grow_fertigation_seeding : treated
    ...
    grow_seed_batch ||--o{ grow_monitoring_seeding : present
...
| grow_harvest | Harvest header linked to a seeding batch for full traceability. Weigh-ins recorded in child table. |
| grow_harvest_weight | Individual weigh-in per container type with quantity. Tare auto-calculated from container definition. |
...
| grow_scout_seeding | Join table linking a scouting activity to one or more seeding batches. |
...
| grow_spray_seeding | Join table linking spraying activities to seeding batches. |
...
Harvest header linked to a seeding batch for full traceability. Individual weigh-ins are recorded in grow_harvest_weight.
...
| org_id | TEXT | NOT NULL, FK → org(id) | |
| farm_id | TEXT | NOT NULL, FK → org_farm(id) | |
| grow_harvest_id | UUID | NOT NULL, FK → grow_harvest(id) | |
