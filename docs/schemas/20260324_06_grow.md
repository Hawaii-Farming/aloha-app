...
erDiagram
    ...
    grow_input_compliance ||--o{ grow_spraying_input : regulates
...
| ops_task_tracker_id | UUID | NOT NULL, FK → ops_task_tracker(id) | |
| invnt_item_id | TEXT | NOT NULL, FK → invnt_item(id) | |
| grow_input_compliance_id | UUID | FK → grow_input_compliance(id), nullable | Active compliance record; used to derive PHI/REI safety intervals |
