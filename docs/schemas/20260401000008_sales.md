...
Competitor products observed during store visits. Combines farm/brand identity with product details for market intelligence tracking.

| Column | Type | Constraints | Description |
|--------|------|-------------|-------------|
| id | TEXT | PK | |
| org_id | TEXT | NOT NULL, FK → org(id) | |
| farm_name | TEXT | NOT NULL | Competitor brand or farm name (e.g. Sensei, Nalo, Earthbound Farm) |
| farm_location | TEXT | nullable | Origin of the competitor farm (e.g. HI, CA, Mexico) |
| variety | TEXT | NOT NULL | |
| size | TEXT | nullable | |
| size_uom | TEXT | FK → sys_uom(code), nullable | |
| packaging | TEXT | nullable | |
| is_organic | BOOLEAN | NOT NULL, default false | |
| display_order | INTEGER | NOT NULL, default 0 | |
| is_active | BOOLEAN | NOT NULL, default true | |

Unique constraint on `(org_id, farm_name, variety, size, packaging)`.
...
| notes | TEXT | nullable | |
| customer_notes | TEXT | nullable | Notes from conversations with the store manager or produce buyer |
