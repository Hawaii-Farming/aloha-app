...
Migration: `supabase/migrations_future/20260326_001_invnt_sales_product_item.sql`
...
Migration: `supabase/migrations_future/20260326_002_invnt_usage.sql`
...
| burn_uom       | TEXT         | FK → sys_uom(code), nullable | Sourced from the triggering module record (e.g. grow_spray_compliance.burn_uom) |
| quantity_burn  | NUMERIC      | NOT NULL                      | Auto-calculated from the triggering module based on application quantity and burn rate |
...
Migration: `supabase/migrations_future/20260326_003_hr_travel_request.sql`
...
Migration: `supabase/migrations_future/20260326_004_hr_disciplinary_warning.sql`
