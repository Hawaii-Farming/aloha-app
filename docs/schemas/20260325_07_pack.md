...
erDiagram
    ...
    pack_packaging_type ||--o{ pack_shelf_life : packages
...
| pack_packaging_type | Org-defined packaging type lookup (e.g. clamshell, bag, sleeve, tray wrap). Referenced by both sales_product and pack_shelf_life. |
...
Org-defined packaging type lookup (e.g. clamshell, bag, sleeve, tray wrap). Referenced by both `sales_product` and `pack_shelf_life`.
...
| org_id | TEXT | NOT NULL, FK → org(id) | Owning organization for RLS filtering |
| farm_id | TEXT | FK → org_farm(id), nullable | Optional farm scope; inherited from parent pack_shelf_life |
| pack_shelf_life_id | UUID | NOT NULL, FK → pack_shelf_life(id) | Trial this observation belongs to |
| pack_shelf_life_metric_id | TEXT | NOT NULL, FK → pack_shelf_life_metric(id) | Check being recorded in this observation |
...
| org_id | TEXT | NOT NULL, FK → org(id) | Owning organization for RLS filtering |
| farm_id | TEXT | FK → org_farm(id), nullable | Optional farm scope; inherited from parent pack_shelf_life |
| pack_shelf_life_id | UUID | NOT NULL, FK → pack_shelf_life(id) | Trial this photo belongs to |
| observation_date | DATE | NOT NULL | |
