...
| item_per_pack_uom           | NUMERIC      | nullable                           | |
| sale_uom                    | TEXT         | FK → sys_uom(code), nullable      | |
| pack_per_sale_uom           | NUMERIC      | nullable                           | |
| shipping_uom                | TEXT         | FK → sys_uom(code), nullable      | |
| max_sale_per_shipping_uom   | NUMERIC      | nullable                           | |
| pack_net_weight             | NUMERIC      | nullable                           | |
| sale_net_weight             | NUMERIC      | nullable                           | |
| shipping_net_weight         | NUMERIC      | nullable                           | |
| weight_uom                  | TEXT         | FK → sys_uom(code), nullable      | |
| sale_uom_length             | NUMERIC      | nullable                           | |
| sale_uom_width              | NUMERIC      | nullable                           | |
| sale_uom_height             | NUMERIC      | nullable                           | |
| dimension_uom               | TEXT         | FK → sys_uom(code), nullable      | |
| manufacture_storage_method  | TEXT         | nullable                           | |
...
| shipping_ti                 | NUMERIC      | nullable                           | |
| shipping_hi                 | NUMERIC      | nullable                           | |
...
| sales_customer_group_id | TEXT | FK → sales_customer_group(id), nullable | |
| sales_donation_recipient_id | TEXT | FK → sales_donation_recipient(id), nullable | |
...
| notes | TEXT | nullable | |
| status | TEXT | NOT NULL, default draft, CHECK | draft, approved, fulfilled |
...
| sale_uom | TEXT | NOT NULL, FK → sys_uom(code) | |
