...
```mermaid
erDiagram
    farm ||--o{ pack_lot : "produces"
    pack_lot ||--o{ pack_lot_item : "contains"
    sales_product ||--o{ pack_lot_item : "packed as"
    util_uom ||--o{ pack_lot_item : "measures"

    pack_packaging_type ||--o{ pack_shelf_life_trial : "tests"
    pack_lot ||--o{ pack_shelf_life_trial : "sampled from"
    sales_product ||--o{ pack_shelf_life_trial : "tested as"
    pack_shelf_life_trial ||--o{ pack_shelf_life_observation : "observed in"
    pack_shelf_life_check ||--o{ pack_shelf_life_observation : "checked by"
    pack_shelf_life_trial ||--o{ pack_shelf_life_photo : "photographed in"
    ...
    pack_lot_item {
        ...
        TEXT org_id FK
        UUID pack_lot_id FK
        TEXT sales_product_id FK
        DATE best_by_date
        TEXT uom FK
        NUMERIC quantity_packed
    }
    ...
    pack_shelf_life_trial {
        ...
        UUID pack_lot_id FK
        TEXT sales_product_id FK
        TEXT pack_packaging_type_id FK
        INTEGER target_shelf_life_days
        INTEGER final_shelf_life_days
        TEXT status
    }
    ...
    pack_shelf_life_observation {
        UUID id PK
        TEXT org_id FK
        UUID pack_shelf_life_trial_id FK
        TEXT pack_shelf_life_check_id FK
...
> **Note:** This migration also adds `pack_packaging_type_id` (TEXT, FK → pack_packaging_type) to `sales_product` via ALTER TABLE.
