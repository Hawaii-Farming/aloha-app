...
erDiagram
    ...
    farm ||--o{ maint_request_invnt_item : scoped
...
| org_id            | TEXT         | NOT NULL, FK → org(id)                | Owning organization for RLS filtering    |
| farm_id           | TEXT         | FK → farm(id), nullable               | Optional farm scope; inherited from parent maint_request |
...
| is_active         | BOOLEAN      | NOT NULL, default true                | Soft delete flag; false removes the entry without deleting the record |
