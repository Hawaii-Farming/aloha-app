...
| site_id_parent | TEXT | FK → org_site(id), nullable | Null for top-level sites; set for child locations within a parent site (e.g. food safety surfaces, pest traps, housing rooms) |
| name | TEXT | NOT NULL | |
