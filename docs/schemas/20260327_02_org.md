...
GH 01 (category: growing, farm: cuke)
  ├── Station 15 (category: pest_trap)
  ├── Station 16 (category: pest_trap)
  ├── Cravo Roof (category: maintenance)
  └── Link 4 (category: maintenance)

Lettuce PH (category: packing, farm: lettuce)
  ├── Pack Table #3 fcs (category: food_safety, zone: zone_1)
  ├── Dryer Feed Conveyor (category: food_safety, zone: zone_1)
  ├── Cooler Door Handle (category: food_safety, zone: zone_4)
  ├── Station 1 (category: pest_trap)
  ├── Station 2 (category: pest_trap)
  ├── ProSeal (category: maintenance)
  └── Metal Detector (category: maintenance)

Duplex (category: housing)
  ├── Upstairs Bedroom 1 (subcategory: room)
  ├── Upstairs Kitchen (subcategory: room)
  └── Downstairs Living Room (subcategory: room)
```
