...
| ne | hf | cuke | NE | growing | nursery | jtl | 0.5 | [Water, Low, High] | | | | |
| nw | hf | cuke | NW | growing | nursery | jtl | 0.5 | [Water, Low, High] | | | | |
| 01 | hf | cuke | 01 | growing | greenhouse | jtl | 1 | [A, B] | | xxx | yyy | |
| station_01 | hf | cuke | Station 01 | pest_trap | | 01 | | | | | | |
| station_02 | hf | cuke | Station 02 | pest_trap | | 01 | | | | | | |
| station_03 | hf | cuke | Station 03 | pest_trap | | 01 | | | | | | |
| harvest_cart | hf | cuke | Harvest Cart | food_safety | | 01 | | | zone_1 | xxx1 | yyy1 | zzz1 |
| harvest_bin | hf | cuke | Harvest Bin | food_safety | | 01 | | | zone_1 | xxx1 | yyy1 | zzz2 |
| row_01 | hf | cuke | Row 01 | growing | grow_row | 01 | | | | xxx11 | yyy11 | |
| row_02 | hf | cuke | Row 02 | growing | grow_row | 01 | | | | xxx12 | yyy12 | |
| row_03 | hf | cuke | Row 03 | growing | grow_row | 01 | | | | xxx13 | yyy13 | |
| jtl_storage | hf | | JTL Storage | storage | warehouse | jtl | | | | | | |
...
JTL (category: growing, farm: cuke)
  ├── NE (category: growing, subcategory: nursery, 0.5 acres)
  ├── NW (category: growing, subcategory: nursery, 0.5 acres)
  ├── 01 (category: growing, subcategory: greenhouse, 1 acre)
  │   ├── Station 01 (category: pest_trap)
  │   ├── Station 02 (category: pest_trap)
  │   ├── Station 03 (category: pest_trap)
  │   ├── Harvest Cart (category: food_safety, zone: zone_1)
  │   ├── Harvest Bin (category: food_safety, zone: zone_1)
  │   ├── Row 01 (category: growing, subcategory: grow_row)
  │   ├── Row 02 (category: growing, subcategory: grow_row)
  │   └── Row 03 (category: growing, subcategory: grow_row)
  └── JTL Storage (category: storage, subcategory: warehouse, org-wide)
...
Equipment register for all physical assets across the organization. Farm-level or shared (farm_id null).
