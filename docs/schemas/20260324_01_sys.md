...
| name | TEXT | NOT NULL, UNIQUE | |
| level | INTEGER | NOT NULL, UNIQUE | Numeric rank used for access comparisons: higher number = more access (e.g. employee=1, team_lead=2, manager=3, owner=5) |
...
| name | TEXT | NOT NULL | |
| description | TEXT | nullable | |
| sys_access_level_id | TEXT | NOT NULL, FK → sys_access_level(id) | Minimum access level required to view this sub-module; references sys_access_level |
| display_order | INTEGER | NOT NULL, default 0 | |
