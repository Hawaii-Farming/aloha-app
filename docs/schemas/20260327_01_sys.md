...
| sys_pest | Standardized pest names for scouting observations. System-level, shared across all organizations. |
| sys_disease | Standardized disease names for scouting observations. System-level, shared across all organizations. |
