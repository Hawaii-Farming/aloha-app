...
| sale_uom            | TEXT         | FK → org_uom(code), nullable         | Unit of measure for the sale quantity at this packaging level |
...
| burn_uom       | TEXT         | FK → org_uom(code), nullable | Unit of measure for the burn quantity    |
