...
| site_id              | TEXT         | FK → org_site(id), nullable                  | Sourced from fsafe_lab_test.atp_site_count random selection of zone_1 sites; null for standard checklist responses |
