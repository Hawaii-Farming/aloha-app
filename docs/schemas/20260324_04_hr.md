...
| sys_access_level_id      | TEXT         | NOT NULL, FK → sys_access_level(id)      | System access level: owner, manager, team_lead, or employee. Drives frontend permissions via dropdown selection. |
