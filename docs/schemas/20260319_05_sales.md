...
| pack_packaging_type_id      | TEXT         | FK → pack_packaging_type(id), nullable | Packaging type for this product; FK to org-defined pack_packaging_type lookup; FK added via ALTER TABLE in pack_packaging_type migration |
