...
| payroll_processor        | TEXT         | nullable                                 | Payroll administrator responsible for employee compensation (e.g. HRB, HF) |
| pay_delivery_method      | TEXT         | nullable                                 | How pay stubs are delivered (e.g. email, print, portal) |
...
| non_pto_days    | NUMERIC      | nullable                          | Number of days not charged to PTO or sick leave (e.g. unpaid leave, personal days) |
