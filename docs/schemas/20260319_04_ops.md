...
erDiagram
    ...
    farm ||--o{ ops_task_schedule : scoped
...
| org_id                | TEXT         | NOT NULL, FK → org(id)                   | Owning organization for RLS filtering    |
| farm_id               | TEXT         | FK → farm(id), nullable                  | Optional farm scope; inherited from parent ops_task_tracker |
...
| org_id                  | TEXT         | NOT NULL, FK → org(id)                | Owning organization for RLS filtering    |
| farm_id                 | TEXT         | FK → farm(id), nullable               | Optional farm scope; inherited from parent ops_training |
...
| site_id              | TEXT         | FK → site(id), nullable                  | Site where the ATP test was conducted; null for standard checklist responses which are not site-specific |
