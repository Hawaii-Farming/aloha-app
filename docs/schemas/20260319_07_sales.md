...
erDiagram
    ...
    org_uom ||--o{ sales_po_line : measures
...
| item_uom                    | TEXT         | FK → org_uom(code), nullable      | Unit of measure for the individual product item (e.g. each, head) |
| pack_uom                    | TEXT         | FK → org_uom(code), nullable      | Unit of measure for the consumer pack level (e.g. bag, clamshell) |
| item_per_pack_uom           | NUMERIC      | nullable                           | Number of items per pack                 |
| sale_uom                    | TEXT         | FK → org_uom(code), nullable      | Unit of measure for the sale level (e.g. case, box) |
| pack_per_sale_uom           | NUMERIC      | nullable                           | Number of packs per sale unit            |
| shipping_uom                | TEXT         | FK → org_uom(code), nullable      | Unit of measure for the shipping level (e.g. pallet) |
...
| weight_uom                  | TEXT         | FK → org_uom(code), nullable      | Unit of measure for all net weight values on this product (e.g. lb, kg) |
...
| dimension_uom               | TEXT         | FK → org_uom(code), nullable      | Unit of measure for all dimension values on this product (e.g. in, cm) |
...
| temperature_uom             | TEXT         | FK → org_uom(code), nullable      | Unit of measure for storage temperature values (e.g. F, C) |
...
| sale_uom | TEXT | NOT NULL, FK → org_uom(code) | Unit of measure for the quantity ordered (e.g. case, box) |
