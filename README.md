...
## System Module (6 tables) — [Docs](docs/schemas/20260330_01_sys.md)
...
## Organization Module (8 tables) — [Docs](docs/schemas/20260330_02_org.md)
...
## Inventory Module (8 tables, includes 1 view) — [Docs](docs/schemas/20260330_03_invnt.md)
...
## Human Resources Module (9 tables) — [Docs](docs/schemas/20260330_04_hr.md)
...
## Operations Module (14 tables, includes 1 view) — [Docs](docs/schemas/20260330_05_ops.md)
...
## Grow Module (20 tables, 1 view) — [Docs](docs/schemas/20260330_06_grow.md)
...
## Pack Module (10 tables) — [Docs](docs/schemas/20260330_07_pack.md)
...
## Sales Module (8 tables) — [Docs](docs/schemas/20260330_08_sales.md)
...
## Maintenance Module (2 tables) — [Docs](docs/schemas/20260330_09_maint.md)
...
## Food Safety Module (6 tables) — [Docs](docs/schemas/20260330_10_fsafe.md)
...
- [System Schema](docs/schemas/20260330_01_sys.md) — 4 system-level tables
- [Org Schema](docs/schemas/20260330_02_org.md) — 8 organization structure tables
- [Inventory Schema](docs/schemas/20260330_03_invnt.md) — Items, orders, transactions, and views
- [Human Resources Schema](docs/schemas/20260330_04_hr.md) — Employee records and Human Resources lookups
- [Operations Schema](docs/schemas/20260330_05_ops.md) — Task tracking, training, and food safety checklists
- [Grow Schema](docs/schemas/20260330_06_grow.md) — Seeding, harvesting, scouting, spraying, fertigation, and monitoring
- [Pack Schema](docs/schemas/20260330_07_pack.md) — Lot tracking, shelf life trials, and hourly productivity
- [Sales Schema](docs/schemas/20260330_08_sales.md) — Product catalog, pricing, orders, and fulfillment
- [Maintenance Schema](docs/schemas/20260330_09_maint.md) — Work orders and parts usage
- [Food Safety Schema](docs/schemas/20260330_10_fsafe.md) — EMP testing, lab management, test-and-hold, and pest trap inspections
...
- [Org Provisioning](docs/processes/20260330_01_org_provisioning.md) — New org setup and module seeding
- [User Access Flow](docs/processes/20260330_02_user_access_flow.md) — Login, org selection, and multi-layered access control
- [Grow Seeding](docs/processes/20260330_03_grow_seeding_workflow.md) — Seeding batch creation and lifecycle
- [Grow Harvesting](docs/processes/20260330_04_grow_harvesting_workflow.md) — Harvest weigh-in and grading
- [Grow Scouting](docs/processes/20260330_05_grow_scouting_workflow.md) — Pest and disease observation
- [Grow Spraying](docs/processes/20260330_06_grow_spraying_workflow.md) — Chemical application with compliance enforcement
- [Grow Fertigation](docs/processes/20260330_07_grow_fertigation_workflow.md) — Fertilizer recipe application
- [Grow Monitoring](docs/processes/20260330_08_grow_monitoring_workflow.md) — Environmental readings with calculated points
- [Ops Task Workflow](docs/processes/20260330_09_ops_template_workflow.md) — General task + checklist workflow with ATP testing
- [Pack Productivity](docs/processes/20260330_10_pack_productivity_workflow.md) — Hourly pack line tracking with crew and fail logging
