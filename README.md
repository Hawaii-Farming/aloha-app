...
**`access-control/`** -- Module-level access control. Exports view contract types (`AppNavModule`, `AppNavSubModule`) and the `requireModuleAccess` route guard that checks `hr_rba_navigation` before rendering a module page.
...
| `hr_rba_navigation` | One row per accessible sub-module for the current user, with parent module info and ABAC permissions (pre-filtered by feature toggles, RBAC access level, and `hr_module_access`) |
...
## System Module (6 tables) — [Docs](docs/schemas/20260408000001_sys.md)
...
## Organization Module (8 tables) — [Docs](docs/schemas/20260408000002_org.md)
...
## Inventory Module (8 tables, includes 1 view) — [Docs](docs/schemas/20260408000003_invnt.md)
...
## Human Resources Module (10 tables) — [Docs](docs/schemas/20260408000004_hr.md)
...
- **ops_corrective_action_taken** — Corrective actions raised against failing checklist responses, EMP test results, or pest trap inspections with assignment, due date, result tracking, and verification

## Grow Module (20 tables, 1 view) — [Docs](docs/schemas/20260408000006_grow.md)
...
## Pack Module (10 tables) — [Docs](docs/schemas/20260408000007_pack.md)
...
## Sales Module (14 tables) — [Docs](docs/schemas/20260408000008_sales.md)
...
## Maintenance Module (3 tables) — [Docs](docs/schemas/20260408000009_maint.md)
...
## Food Safety Module (6 tables) — [Docs](docs/schemas/20260408000010_fsafe.md)
...
- [System Schema](docs/schemas/20260408000001_sys.md) — 6 system-level tables
- [Org Schema](docs/schemas/20260408000002_org.md) — 8 organization structure tables
- [Inventory Schema](docs/schemas/20260408000003_invnt.md) — Items, orders, transactions, and views
- [Human Resources Schema](docs/schemas/20260408000004_hr.md) — Employee records and Human Resources lookups
- [Operations Schema](docs/schemas/20260408000005_ops.md) — Task tracking, training, and food safety checklists
- [Grow Schema](docs/schemas/20260408000006_grow.md) — Seeding, harvesting, scouting, spraying, fertigation, and monitoring
- [Pack Schema](docs/schemas/20260408000007_pack.md) — Lot tracking, shelf life trials, and hourly productivity
- [Sales Schema](docs/schemas/20260408000008_sales.md) — Product catalog, pricing, orders, and fulfillment
- [Maintenance Schema](docs/schemas/20260408000009_maint.md) — Work orders and parts usage
- [Food Safety Schema](docs/schemas/20260408000010_fsafe.md) — EMP testing, lab management, test-and-hold, and pest trap inspections
...
- [Org Provisioning](docs/processes/20260408000001_org_provisioning.md) — New org setup and module seeding
- [User Access Flow](docs/processes/20260408000002_user_access_flow.md) — Login, org selection, and multi-layered access control
- [Grow Seeding](docs/processes/20260408000003_grow_seeding_workflow.md) — Seeding batch creation and lifecycle
- [Grow Harvesting](docs/processes/20260408000004_grow_harvesting_workflow.md) — Harvest weigh-in and grading
- [Grow Scouting](docs/processes/20260408000005_grow_scouting_workflow.md) — Pest and disease observation
- [Grow Spraying](docs/processes/20260408000006_grow_spraying_workflow.md) — Chemical application with compliance enforcement
- [Grow Fertigation](docs/processes/20260408000007_grow_fertigation_workflow.md) — Fertilizer recipe application
- [Grow Monitoring](docs/processes/20260408000008_grow_monitoring_workflow.md) — Environmental readings with calculated points
- [Ops Task Workflow](docs/processes/20260408000009_ops_template_workflow.md) — General task + checklist workflow with ATP testing
- [Pack Productivity](docs/processes/20260408000010_pack_productivity_workflow.md) — Hourly pack line tracking with crew and fail logging
